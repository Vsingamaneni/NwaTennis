...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <table class="container">
        ...
        <tbody>
        <tr>
            <td data-column="Members ">${teamDetails.poolPosition}</td>
            <td data-column="Members ">${teamDetails.firstName} ${teamDetails.lastName} <br /> ${teamDetails.firstName1} ${teamDetails.lastName1}</td>
            <td data-column="Twitter">${teamDetails.phone} <br /> ${teamDetails.phone1}</td>
        </tr>
        </tbody>
        </c:forEach>
    </table>
