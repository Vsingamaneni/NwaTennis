...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <a href="/pool/mixed" style="text-decoration : none;" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user"></i>&nbsp; Player Details</a>
    ...
    <a href="/knockouts/mixed" style="text-decoration : none;" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bar-chart"></i>&nbsp; Knockouts</a>
    ...
    <a href="/knockouts/mens" style="text-decoration : none;" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bar-chart"></i>&nbsp; Knockouts</a>
