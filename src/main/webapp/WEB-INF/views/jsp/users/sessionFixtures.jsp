...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    <div class="w3-container w3-row">
        ...
        <div class="w3-col s8 w3-bar">
            ...
            <a href="/fixtures/mens" style="text-decoration : none;" class="w3-bar-item w3-button w3-padding"><i
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <h1 style="text-align: center; color:black;"><span class="#1F2739">Fixtures @ Session</span></h1>
    <br />

    <c:if test="${not empty mensSessionFixtures}">
    <h3 style="text-align: center; color:black;"><span class="#1F2739">Mens Doubles</span></h3>
    <c:forEach items="${mensSessionFixtures}" var="fixturesMap">
    <button class="collapsible">${fixturesMap.key}</button>
    <div class="content">
        <p>
        ...
        <table class="container">
            <thead>
            <tr>
                <th align="center"><h1 style="color: skyblue; ">Pool</h1></th>
            ...
            <c:forEach items="${fixturesMap.value}" var="fixtures">
            <tbody>
            <tr>
                <td align="center" style="color: ghostwhite; ">${fixtures.pool}</td>
                ...
                <%--<c:if test="${not empty fixtures.viewStats}">
                    <td align="center" style="color: ghostwhite; "><a style="text-decoration: none;"
                                                                      href="${fixtures.viewStats}"
                                                                      target="_blank">${fixtures.result}</a></td>
                </c:if>
    ...
    <br />
    <br />
    <c:if test="${not empty mixedSessionFixtures}">
    <h3 style="text-align: center; color:black;"><span class="#1F2739">Mixed Doubles</span></h3>
    <c:forEach items="${mixedSessionFixtures}" var="fixturesMap">
    <button class="collapsible">${fixturesMap.key}</button>
    <div class="content">
        <p>
