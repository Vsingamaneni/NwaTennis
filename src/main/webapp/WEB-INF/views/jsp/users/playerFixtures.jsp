...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <table class="container">
        ...
        <c:forEach items="${sf}" var="fixtures">
        <tbody>
        <tr>
    ...
    <table class="container">
        ...
        <c:forEach items="${qf}" var="fixtures">
        <tbody>
        <tr>
            <td style="color: ghostwhite; ">${fixtures.matchdate}</td>
            <td style="color: ghostwhite; ">${fixtures.time}</td>
    ...
    <c:if test="${not empty r16}">
    <h1 style="color: #1F2739"><span class="#1F2739">Round Of 16</span></h1>
    <table class="container">
        <thead>
        <tr>
            <th align = "center"><h1 style="color: skyblue;">Date</h1></th>
        ...
        <c:forEach items="${r16}" var="fixtures">
        <tbody>
        <tr>
