...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <h1 style="text-align: center; color:black;"><span class="#1F2739">Standings</span></h1>
    <br /><br />

    <c:forEach items="${standingsMap}" var="standingsMap">

    <table class="container">
        <thead>
        <tr>
            <th><h1 style="color: skyblue; text-align: center;">Rank</h1></th>
            <th><h1 style="color: skyblue; text-align: center;">Pool ${standingsMap.key}</h1></th>
        ...
        <c:forEach items="${standingsMap.value}" var="standings">
        <tbody>
        <tr>
